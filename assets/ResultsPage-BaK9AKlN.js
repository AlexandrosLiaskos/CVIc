const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dom-to-image-ClVmkNWP.js","assets/index-CFtzeYoU.js","assets/index-Cj-sxlKB.css","assets/index-B6Dv96TN.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, c as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, R as React, _ as __vitePreload, u as useNavigate } from "./index-CFtzeYoU.js";
import { i as indexedDBService } from "./indexedDBService-6nGGrobl.js";
import { h as getCviCategory, c as featureCollection, b as bbox, M as Map$1 } from "./Map-Dbk5FvJw.js";
import { E as ErrorAlert } from "./ErrorAlert-NBmdjZJ0.js";
import { a as availableFormulas } from "./formulas-CIcQv-hn.js";
import { g as getStandardizedIndexById } from "./indices-CCVn6S0N.js";
import "./leaflet.draw-BJ_1h2tb.js";
const CviLegend = () => {
  const categories = [
                ...
                content: ({ active, payload, label }) => {
                  if (active && payload && payload.length) {
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-2 border border-gray-200 shadow-sm rounded", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: `Segment ${label} (${item?.category})` }),
...
const captureMapWithDomToImage = (mapElement) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./dom-to-image-ClVmkNWP.js").then((n) => n.d), true ? __vite__mapDeps([0,1,2]) : void 0).then((domtoimage) => {
      console.log("Using dom-to-image to capture map...");
      const mapInstance = window.L?.Maps?.[0] || null;
      if (!mapInstance) {
...
const captureMapWithLeafletImage = (mapInstance) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./index-B6Dv96TN.js").then((n) => n.i), true ? __vite__mapDeps([3,1,2]) : void 0).then((leafletImageModule) => {
...
function ResultsPage() {
  ...
  reactExports.useEffect(() => {
    const loadResultsData = async () => {
      ...
      try {
        ...
        const loadedSegments = segmentData.features.filter((feature) => feature && feature.geometry && (feature.geometry.type === "LineString" || feature.geometry.type === "MultiLineString") && feature.properties?.vulnerabilityIndex !== void 0).map((feature, index) => {
        ...
        if (parameterData && parameterData.features) {
          const loadedParameters = parameterData.features.map((feature) => feature.properties).filter((p) => p !== null && p.enabled === true);
  ...
  const cviStatistics = reactExports.useMemo(() => {
    ...
    const sum = scores.reduce((a2, b) => a2 + b, 0);
  ...
  const handleExportHtmlReport = reactExports.useCallback(async () => {
    ...
    try {
      ...
      const mapInstance = window.L?.Maps?.[0];
      if (mapInstance) {
        try {
          if (mapInstance.stop) {
            mapInstance.stop();
...
//# sourceMappingURL=ResultsPage-BaK9AKlN.js.map
