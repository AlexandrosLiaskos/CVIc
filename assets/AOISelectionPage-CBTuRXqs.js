import { r as reactExports, j as jsxRuntimeExports, u as useNavigate, F as ForwardRef } from "./index-DZm5JGOi.js";
...
import { F as ForwardRef$1 } from "./ArrowLeftIcon-BKzwo4sl.js";
import { F as ForwardRef$2 } from "./ArrowRightIcon-7c6dXZNM.js";
  ...
  reactExports.useEffect(() => {
    ...
    if (images && images.length > 0) {
      ...
      images.forEach((image) => {
        ...
        try {
          let layer;
          if ((_a = image.metadata) == null ? void 0 : _a.isSentinel) {
            ...
            const utmZone = ((_c = (_b = image.metadata) == null ? void 0 : _b.sentinelInfo) == null ? void 0 : _c.utmZone) || "Unknown";
            const band = ((_e = (_d = image.metadata) == null ? void 0 : _d.sentinelInfo) == null ? void 0 : _e.band) || "Unknown";
            const satellite = ((_g = (_f = image.metadata) == null ? void 0 : _f.sentinelInfo) == null ? void 0 : _g.satellite) || "Sentinel-2";
            const date = ((_i = (_h = image.metadata) == null ? void 0 : _h.sentinelInfo) == null ? void 0 : _i.date) || "Unknown date";
            const productType = ((_k = (_j = image.metadata) == null ? void 0 : _j.sentinelInfo) == null ? void 0 : _k.productType) || "";
            ...
            `);
            const isJP2 = (_l = image.metadata) == null ? void 0 : _l.isJP2;
            let imageBounds;
            if (isJP2) {
      ...
      if (mapRef.current) {
        imageLayersRef.current.forEach((layer) => {
          ...
          if (Array.isArray(layer)) {
            layer.forEach((subLayer) => {
              var _a2;
              (_a2 = mapRef.current) == null ? void 0 : _a2.removeLayer(subLayer);
            });
          } else {
...
//# sourceMappingURL=AOISelectionPage-CBTuRXqs.js.map
