const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dom-to-image-C7Ov-5vq.js","assets/index-Cgv5OTPG.js","assets/index-DS_5DDJt.css","assets/index-CdNBG0V3.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, d as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, R as React, _ as __vitePreload, u as useNavigate } from "./index-Cgv5OTPG.js";
import { indexedDBService } from "./indexedDBService-BebV9TT6.js";
import { n as getCviCategory, c as featureCollection, b as bbox, M as Map$5 } from "./Map-BCTR41zO.js";
import { E as ErrorAlert } from "./ErrorAlert-DnB5Pv1Q.js";
import { a as availableFormulas } from "./formulas-CWbHTCK9.js";
import { g as getStandardizedIndexById } from "./standardizedIndices-D_e6-F-z.js";
import "./leaflet.draw-DH9dL00l.js";
const CviLegend = () => {
  const categories = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: categories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center group hover:bg-gray-100 p-1.5 rounded-md transition-colors", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center mr-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `w-5 h-5 rounded-full flex-shrink-0 ${category.color} border ${category.border} shadow-sm group-hover:scale-110 transition-transform` }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-sm font-medium ${category.textColor}`, children: category.label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500", children: category.rank > 0 ? `Vulnerability Rank: ${category.rank}` : "No vulnerability data" })
    ] })
  ] }, category.label)) });
};
function r(e3) {
...
function bisector$1(f2) {
  ...
  if (f2.length !== 2) {
    ...
    compare1 = f2 === ascending$1 || f2 === descending$1 ? f2 : zero$2;
    compare2 = f2;
    delta = f2;
  }
...
function ticks(start, stop, count) {
  ...
  const reverse3 = stop < start, [i1, i2, inc] = reverse3 ? tickSpec$1(stop, start, count) : tickSpec$1(start, stop, count);
  if (!(i2 >= i1)) return [];
...
function tickStep$1(start, stop, count) {
  stop = +stop, start = +start, count = +count;
  const reverse3 = stop < start, inc = reverse3 ? tickIncrement$1(stop, start, count) : tickIncrement$1(start, stop, count);
...
function tickFormat(start, stop, count, specifier) {
  var step = tickStep$1(start, stop, count), precision;
...
function _objectSpread$m(e3) {
  for (var r2 = 1; r2 < arguments.length; r2++) {
    var t2 = null != arguments[r2] ? arguments[r2] : {};
    r2 % 2 ? ownKeys$m(Object(t2), true).forEach(function(r22) {
      _defineProperty$q(e3, r22, t2[r22]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e3, Object.getOwnPropertyDescriptors(t2)) : ownKeys$m(Object(t2)).forEach(function(r22) {
...
const CviCharts = ({
  ...
  const categoryDistributionData = reactExports.useMemo(() => {
  ...
  const vulnerabilityProfileData = reactExports.useMemo(() => {
    if (segments.length === 0) return [];
    const segmentsWithScores = segments.filter((s2) => s2.properties.vulnerabilityIndex !== void 0).map((segment, index) => {
      var _a;
      return {
        id: segment.id,
        index,
        ...
        color: CATEGORY_COLORS[getCviCategory(segment.properties.vulnerabilityIndex || 0, segment.properties.vulnerabilityFormula)],
        isICVI: ((_a = segment.properties.vulnerabilityFormula) == null ? void 0 : _a.includes("icvi")) || false
      };
    ...
    for (let i = 0; i < segmentsWithScores.length; i++) {
      let sum = 0;
      let count = 0;
      for (let j = Math.max(0, i - Math.floor(windowSize / 2)); j <= Math.min(segmentsWithScores.length - 1, i + Math.floor(windowSize / 2)); j++) {
  ...
  const isUsingICVI = reactExports.useMemo(() => {
    return vulnerabilityProfileData.length > 0 && vulnerabilityProfileData[0].isICVI;
  }, [vulnerabilityProfileData]);
  if (!cviStatistics) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-500 italic", children: "No CVI data available for charts" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `space-y-8 ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-4 rounded-lg shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-medium text-gray-800 mb-4", children: "CVI Category Distribution" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        BarChart,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { label: { value: "Segments", angle: -90, position: "insideLeft" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { formatter: (value) => [`${value} segments`, "Count"] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "value", isAnimationActive: false, children: categoryDistributionData.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.color }, `cell-${index}`)) })
          ]
        }
      ) }) })
    ] }),
    vulnerabilityProfileData.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-4 rounded-lg shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-medium text-gray-800 mb-4", children: "Vulnerability Profile Along Shoreline" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ComposedChart,
        {
          ...
          children: [
              ...
              Tooltip,
              {
                content: ({ active, payload, label }) => {
                  if (active && payload && payload.length) {
                    const scorePoint = payload.find((p2) => p2.dataKey === "score");
                    if (!scorePoint) return null;
                    const item = vulnerabilityProfileData.find((d2) => d2.displayId === label);
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-2 border border-gray-200 shadow-sm rounded", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: `Segment ${label} (${item == null ? void 0 : item.category})` }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-600", children: `CVI Score: ${typeof scorePoint.value === "number" ? scorePoint.value.toFixed(3) : scorePoint.value}` })
                    ] });
                  }
                  return null;
                }
            ...
            isUsingICVI ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ReferenceLine, { y: 0.2, stroke: "#4caf50", strokeDasharray: "3 3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ReferenceLine, { y: 0.4, stroke: "#ffeb3b", strokeDasharray: "3 3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ReferenceLine, { y: 0.6, stroke: "#ff9800", strokeDasharray: "3 3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ReferenceLine, { y: 0.8, stroke: "#f44336", strokeDasharray: "3 3" })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ReferenceLine, { y: 1.5, stroke: "#4caf50", strokeDasharray: "3 3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ReferenceLine, { y: 2.5, stroke: "#ffeb3b", strokeDasharray: "3 3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ReferenceLine, { y: 3.5, stroke: "#ff9800", strokeDasharray: "3 3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ReferenceLine, { y: 4.5, stroke: "#f44336", strokeDasharray: "3 3" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Scatter,
              {
                ...
                fill: "#8884d8",
                isAnimationActive: false,
                children: vulnerabilityProfileData.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.color }, `cell-${index}`))
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Line,
...
const generateCategoryDistributionData = (statistics) => {
...
const generateVulnerabilityProfileData = (segments) => {
  if (segments.length === 0) return [];
  const segmentsWithScores = segments.filter((s2) => s2.properties.vulnerabilityIndex !== void 0).map((segment, index) => {
    ...
    const color2 = CATEGORY_COLORS2[category] || "#9e9e9e";
    return {
      id: segment.id,
      index,
      score,
...
const generateHtmlReport = (segments, parameters, statistics, formula, mapImageDataUrl) => {
    ...
    <div class="content">
      <div class="map-container">
        ...
        <div class="map-caption">
          Shoreline segments colored by calculated CVI score. Formula used: ${(formula == null ? void 0 : formula.name) || "Unknown"}
        </div>
      </div>
      ...
      <div class="grid">
        ...
        <div class="card">
          ...
          <div class="parameters-list">
            ${parameters.filter((p2) => p2.enabled && p2.weight > 0).map((param) => `
...
const captureMapWithDomToImage = (mapElement) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./dom-to-image-C7Ov-5vq.js").then((n2) => n2.d), true ? __vite__mapDeps([0,1,2]) : void 0).then((domtoimage) => {
      var _a, _b;
      console.log("Using dom-to-image to capture map...");
      const mapInstance = ((_b = (_a = window.L) == null ? void 0 : _a.Maps) == null ? void 0 : _b[0]) || null;
      if (!mapInstance) {
...
const captureMapWithLeafletImage = (mapInstance) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./index-CdNBG0V3.js").then((n2) => n2.i), true ? __vite__mapDeps([3,1,2]) : void 0).then((leafletImageModule) => {
      ...
      leafletImage(mapInstance, (err, canvas) => {
        ...
        try {
          ...
          console.error("Error converting canvas to data URL:", err2);
          reject(err2);
        }
      });
    }).catch((err) => {
...
const captureMap = async (mapElement) => {
  var _a, _b;
  const mapInstance = ((_b = (_a = window.L) == null ? void 0 : _a.Maps) == null ? void 0 : _b[0]) || null;
  try {
    if (mapInstance) {
...
function ResultsPage() {
  ...
  const [usedFormula, setUsedFormula] = reactExports.useState(null);
  ...
  const [exportingHtml, setExportingHtml] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    const loadResultsData = async () => {
      ...
      try {
        ...
        const loadedSegments = segmentData.features.filter((feature) => {
          var _a2;
          return feature && feature.geometry && (feature.geometry.type === "LineString" || feature.geometry.type === "MultiLineString") && ((_a2 = feature.properties) == null ? void 0 : _a2.vulnerabilityIndex) !== void 0;
        }).map((feature, index) => {
        ...
        if (firstSegmentWithFormula == null ? void 0 : firstSegmentWithFormula.properties.vulnerabilityFormula) {
          const formula = availableFormulas.find((f2) => f2.type === firstSegmentWithFormula.properties.vulnerabilityFormula);
          if (formula) {
        ...
        if (parameterData && parameterData.features) {
          const loadedParameters = parameterData.features.map((feature) => feature.properties).filter((p2) => p2 !== null && p2.enabled === true);
        ...
        if (indexData && indexData.features && indexData.features.length > 0) {
          ...
          if ((_a = indexFeature.properties) == null ? void 0 : _a.id) {
        ...
        const featuresForBounds = loadedSegments.map((s2) => ({ type: "Feature", geometry: s2.geometry, properties: {} }));
        const fc = createFeatureCollection(featuresForBounds);
        try {
          const bbox2 = calculateBbox(fc);
          if (bbox2 && bbox2.length === 4 && bbox2.every((b2) => isFinite(b2)) && bbox2[0] <= bbox2[2] && bbox2[1] <= bbox2[3]) {
          ...
          console.error("Error calculating bounds:", e3);
        }
      } catch (err) {
  ...
  const cviStatistics = reactExports.useMemo(() => {
    const segmentsWithScores = segments.filter((s2) => s2.properties.vulnerabilityIndex !== void 0 && s2.properties.vulnerabilityIndex !== null);
    if (segmentsWithScores.length === 0) return null;
    const scores = segmentsWithScores.map((s2) => s2.properties.vulnerabilityIndex);
    const min2 = Math.min(...scores);
    const max2 = Math.max(...scores);
    const sum = scores.reduce((a2, b2) => a2 + b2, 0);
    ...
    segmentsWithScores.forEach((segment) => {
      const score = segment.properties.vulnerabilityIndex;
  ...
  const handleExportGeoJSON = reactExports.useCallback(() => {
    ...
    try {
      ...
      a2.href = url;
      a2.download = "cvic_results.geojson";
  ...
  const handleExportHtmlReport = reactExports.useCallback(async () => {
    var _a, _b;
    if (segments.length === 0) {
      setError("No segment data available to export.");
      return;
    ...
    try {
      ...
      const mapInstance = (_b = (_a = window.L) == null ? void 0 : _a.Maps) == null ? void 0 : _b[0];
      if (mapInstance) {
        try {
          mapInstance.stop();
          mapInstance.invalidateSize({ animate: false });
          ...
          const geoJSONLayer = mapInstance._layers && Object.values(mapInstance._layers).find(
            (layer) => layer.feature || layer.getLayers && typeof layer.getLayers === "function"
          );
          if (geoJSONLayer) {
      ...
      while (!mapImageDataUrl && attempts < maxAttempts) {
        ...
        try {
          ...
          mapImageDataUrl = await captureMap(mapElement);
        } catch (captureErr) {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center h-screen", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ml-4 text-gray-600", children: "Loading results..." })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto mt-8 px-4 pb-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-center mb-8 text-gray-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-clip-text text-transparent bg-gradient-to-r from-primary-600 to-primary-800", children: "Coastal Vulnerability Index Results" }) }),
    selectedIndex && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white p-6 rounded-xl shadow-md border border-gray-100 mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-xl font-semibold text-gray-800 flex items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5 mr-2 text-primary-600", viewBox: "0 0 20 20", fill: "currentColor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fillRule: "evenodd", d: "M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z", clipRule: "evenodd" }) }),
        "Index Used: ",
        selectedIndex.name
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800", children: selectedIndex.formula }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800", children: [
          selectedIndex.requiredParameters.length,
          " parameters"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800", children: "equal weights" })
      ] })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 bg-white p-6 rounded-xl shadow-md overflow-hidden min-h-[600px] flex flex-col border border-gray-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-gray-800", children: "Vulnerability Map" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 mb-4", children: "Shoreline segments colored by calculated CVI score. Click segments for details." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-grow h-full border rounded-lg overflow-hidden shadow-inner", ref: mapContainerRef, children: geoJSONForMap ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          Map$5,
          {
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full text-gray-500", children: error ? "Error loading map data." : "No results data to display on map." }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1 space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-6 rounded-xl shadow-md border border-gray-100", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-xl font-semibold mb-4 text-gray-800 flex items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5 mr-2 text-primary-600", viewBox: "0 0 20 20", fill: "currentColor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zm6-4a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zm6-3a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z" }) }),
            "Summary Statistics"
          ] }),
          cviStatistics ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-50 p-3 rounded-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-600 mb-2", children: [
                "Calculated for ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: cviStatistics.count }),
                " of ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: cviStatistics.totalSegments }),
                " segments."
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-3 rounded-lg shadow-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 uppercase block", children: "Min CVI" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-medium text-gray-800", children: cviStatistics.min })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-3 rounded-lg shadow-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 uppercase block", children: "Avg CVI" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-medium text-gray-800", children: cviStatistics.avg })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-3 rounded-lg shadow-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 uppercase block", children: "Max CVI" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-medium text-gray-800", children: cviStatistics.max })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-3 mt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 uppercase block mb-3 font-medium", children: "Segment Counts by Category" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 bg-green-600 rounded-full mr-2 border border-green-700" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-700 flex-grow", children: "Very Low" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-gray-800 bg-gray-100 px-2 py-1 rounded-md min-w-[2rem] text-center", children: cviStatistics.categories.veryLow })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 bg-lime-500 rounded-full mr-2 border border-lime-600" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-700 flex-grow", children: "Low" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-gray-800 bg-gray-100 px-2 py-1 rounded-md min-w-[2rem] text-center", children: cviStatistics.categories.low })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 bg-yellow-400 rounded-full mr-2 border border-yellow-500" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-700 flex-grow", children: "Moderate" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-gray-800 bg-gray-100 px-2 py-1 rounded-md min-w-[2rem] text-center", children: cviStatistics.categories.moderate })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 bg-orange-500 rounded-full mr-2 border border-orange-600" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-700 flex-grow", children: "High" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-gray-800 bg-gray-100 px-2 py-1 rounded-md min-w-[2rem] text-center", children: cviStatistics.categories.high })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 bg-red-600 rounded-full mr-2 border border-red-700" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-700 flex-grow", children: "Very High" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-gray-800 bg-gray-100 px-2 py-1 rounded-md min-w-[2rem] text-center", children: cviStatistics.categories.veryHigh })
                ] })
              ] })
            ] })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500", children: "No CVI statistics available." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-6 rounded-xl shadow-md border border-gray-100", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-xl font-semibold mb-4 text-gray-800 flex items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5 mr-2 text-primary-600", viewBox: "0 0 20 20", fill: "currentColor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fillRule: "evenodd", d: "M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 5a1 1 0 011-1h6a1 1 0 110 2H4a1 1 0 01-1-1z", clipRule: "evenodd" }) }),
            "Map Legend"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gray-50 p-3 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CviLegend, {}) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-6 rounded-xl shadow-md border border-gray-100", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-xl font-semibold mb-4 text-gray-800 flex items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5 mr-2 text-primary-600", viewBox: "0 0 20 20", fill: "currentColor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fillRule: "evenodd", d: "M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z", clipRule: "evenodd" }) }),
            "Actions"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-4 w-4 mr-2", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M10 19l-7-7m0 0l7-7m-7 7h18" }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: exportingHtml ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-4 w-4 mr-2", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 6v6m0 0v6m0-6h6m-6 0H6" }) }),
                  "Start New Analysis"
                ]
              }
            )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-6 rounded-xl shadow-md border border-gray-100 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-xl font-semibold mb-6 text-gray-800 flex items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5 mr-2 text-primary-600", viewBox: "0 0 20 20", fill: "currentColor", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 mb-6", children: "Visualization of coastal vulnerability data across analyzed shoreline segments." }),
      cviStatistics ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        CviCharts,
        {
          segments,
          parameters,
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 italic", children: "No CVI data available for charts" })
    ] })
  ] });
}
export {
...
//# sourceMappingURL=ResultsPage-BwbmHesl.js.map
