import { r as reactExports, u as useNavigate, j as jsxRuntimeExports, c as ForwardRef$4 } from "./index-Cgv5OTPG.js";
import { M as Map, f as feature, c as featureCollection, b as bbox } from "./Map-BCTR41zO.js";
...
import { F as ForwardRef$5 } from "./CheckCircleIcon-BdcooX3z.js";
import { l as length } from "./index-Bhf3HYyC.js";
    ...
    const loadSegments = async () => {
      ...
      try {
        ...
        const loadedSegments = data.features.filter(
          ...
          var _a2, _b;
          const segmentId = ((_a2 = feature$1.properties) == null ? void 0 : _a2.id) || `segment-${index + 1}`;
          let length$1 = (_b = feature$1.properties) == null ? void 0 : _b.length;
  ...
  const sortedSegments = reactExports.useMemo(() => {
    return [...filteredSegments].sort((a, b) => {
      ...
      for (const field of fields) {
        aValue = aValue == null ? void 0 : aValue[field];
        bValue = bValue == null ? void 0 : bValue[field];
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8", children: [
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "tr",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 whitespace-nowrap text-sm text-gray-500 text-center w-32", children: ((_a2 = segment.properties) == null ? void 0 : _a2.length) ? segment.properties.length.toFixed(1) : "N/A" })
                      ]
                    },
                    segment.id
                  );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1 flex flex-col", children: [
        ...
        selectedSegmentId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 p-3 bg-blue-50 border border-blue-200 rounded-md text-sm text-blue-800 flex items-center", children: [
          ...
          ((_a = segments.find((s) => s.id === selectedSegmentId)) == null ? void 0 : _a.properties.index) || "",
...
//# sourceMappingURL=SegmentTablePage-BU0ILRZ7.js.map
