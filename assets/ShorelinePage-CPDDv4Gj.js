import { r as reactExports, b as proj4, u as useNavigate, j as jsxRuntimeExports } from "./index-Cgv5OTPG.js";
import { indexedDBService } from "./indexedDBService-BebV9TT6.js";
import { M as Map } from "./Map-BCTR41zO.js";
import { E as ErrorAlert } from "./ErrorAlert-DnB5Pv1Q.js";
import { F as ForwardRef$1 } from "./ArrowUpTrayIcon-Di7RnUW9.js";
import { F as ForwardRef$2 } from "./CheckCircleIcon-BdcooX3z.js";
import { F as ForwardRef$3 } from "./XCircleIcon-0k2uOXIe.js";
...
try {
  g(), d = async (t) => {
    let s = g(), e = s.writable.getWriter(), f = s.readable.getReader(), n, l = [], a = 0, i = 0, o;
    for (e.write(t), e.close(); !(o = await f.read()).done; ) n = o.value, l.push(n), a += n.length;
    return l.length - 1 ? (n = new Uint8Array(a), l.map((r) => (n.set(r, i), i += r.length)), n) : l[0];
  };
} catch {
}
...
function* m(t, s = d) {
  ...
  e === -1 && u(2);
  let n = (r, w) => t.subarray(e += r, e += w), l = new DataView(t.buffer, t.byteOffset), a = (r) => l.getUint16(r + e, true), i = (r) => l.getUint32(r + e, true), o = a(10);
  for (o !== a(8) && u(3), e = i(16); o--; ) {
    let r = a(10), w = a(30), b = a(32), p = i(20), y = i(42), x = h(n(46, a(28))), D = h(n(w, b)), v = e, c;
    e = y, c = n(30 + a(26) + a(28), p), yield { filename: x, comment: D, read: () => r & 8 ? s(c) : r ? u(1) : c }, e = v;
  }
}
...
const checkSuffix = (base, suffix) => {
  var _a;
  const url = new URL(base, (_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.location);
...
function ShorelinePage() {
  ...
  const handleFileChange = (e) => {
    var _a;
    handleFileProcess(((_a = e.target.files) == null ? void 0 : _a[0]) ?? null);
    e.target.value = "";
  };
...
//# sourceMappingURL=ShorelinePage-CPDDv4Gj.js.map
