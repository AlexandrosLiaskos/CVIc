import { u as useNavigate, r as reactExports, j as jsxRuntimeExports } from "./index-CFO2GDfn.js";
import { indexedDBService } from "./indexedDBService-BebV9TT6.js";
import { g as getStandardizedIndexById, v as validateIndexParameters, S as STANDARDIZED_COASTAL_INDICES } from "./standardizedIndices-D_e6-F-z.js";
import { g as getParameterById, a as getParameterByAlias, P as PARAMETER_CATEGORY_LABELS } from "./standardParameters-pkf5Qrqa.js";
function ParameterSelectionPage() {
  ...
  const handleIndexChange = (indexId) => {
    ...
    if ((newIndex == null ? void 0 : newIndex.availableFormulas) && newIndex.availableFormulas.length > 0) {
      setSelectedFormula(newIndex.availableFormulas[0].id);
    } else if (newIndex) {
      setSelectedFormula(newIndex.formula);
    }
  };
  const effectiveFormula = selectedFormula || ((currentIndex == null ? void 0 : currentIndex.formula) ?? "");
  ...
  const getParameterCategory = (standardName) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto mt-8 px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8 min-h-[700px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg border border-gray-200 p-6 flex flex-col", children: [
        ...
        (currentIndex == null ? void 0 : currentIndex.availableFormulas) && currentIndex.availableFormulas.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
          ...
          selectedFormula && currentIndex.availableFormulas.find((f) => f.id === selectedFormula) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-gray-600", children: (_a = currentIndex.availableFormulas.find((f) => f.id === selectedFormula)) == null ? void 0 : _a.description })
        ] }),
        currentIndex && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-gray-300 rounded-lg shadow-sm p-6 mb-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 items-center", children: Object.entries(getParameterCategoryCounts()).map(([category, count]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-gray-700", children: [
              count,
              " × ",
...
//# sourceMappingURL=ParameterSelectionPage-BaRO9CnG.js.map
