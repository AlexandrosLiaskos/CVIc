const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dom-to-image-CQM6Bh8c.js","assets/index-DZm5JGOi.js","assets/index-kagPrk-M.css","assets/index-BSqAhcy1.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, c as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, R as React, _ as __vitePreload, u as useNavigate } from "./index-DZm5JGOi.js";
import { i as indexedDBService } from "./indexedDBService-C5arrTvJ.js";
import { n as getCviCategory, c as featureCollection, b as bbox, M as Map$5 } from "./Map-VYnvIQGB.js";
...
const captureMapWithDomToImage = (mapElement) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./dom-to-image-CQM6Bh8c.js").then((n2) => n2.d), true ? __vite__mapDeps([0,1,2]) : void 0).then((domtoimage) => {
      var _a, _b;
...
const captureMapWithLeafletImage = (mapInstance) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./index-BSqAhcy1.js").then((n2) => n2.i), true ? __vite__mapDeps([3,1,2]) : void 0).then((leafletImageModule) => {
...
//# sourceMappingURL=ResultsPage-CT0fNBi7.js.map
