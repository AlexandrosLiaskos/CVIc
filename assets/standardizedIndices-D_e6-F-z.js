...
const CVI_VALIDATION_RULES = [
  ...
  },
  {
    ...
    validate: (parameters, weights) => {
      ...
      return Object.values(weights).every((w) => Math.abs(w - expectedWeight) < 1e-3);
    }
  },
  {
...
const STANDARDIZED_COASTAL_INDICES = [
  {
    id: "cvi-thieler-1999",
...
Cogswell, A., Greenan, B. J. W., & Greyson, P. (2018). Evaluation of two common vulnerability index calculation methods. Ocean & Coastal Management, 160, 46-51. https://doi.org/10.1016/j.ocecoaman.2018.03.041`,
    ...
    // CVI = ∏(Vi^Wi) - geometric mean preferred over traditional
...
* The classification of parameters into categories is derived from (Roukounis & Tsihrintzis, 2022).`
  },
  {
    ...
    resultClassification: {
      ...
      geometricRanges: [
        { min: 0, max: 22e-4, label: "Very Low", color: "#1a9850" },
        { min: 22e-4, max: 0.0238, label: "Low", color: "#91cf60" },
...
const getStandardizedIndexById = (id) => {
  return STANDARDIZED_COASTAL_INDICES.find((index) => index.id === id);
};
const validateIndexParameters = (indexId, parameters, weights) => {
...
//# sourceMappingURL=standardizedIndices-D_e6-F-z.js.map
