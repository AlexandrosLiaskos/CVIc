import { r as reactExports, j as jsxRuntimeExports, u as useNavigate } from "./index-CFtzeYoU.js";
import { L } from "./leaflet.draw-BJ_1h2tb.js";
import { G as GeoRasterLayer } from "./georaster-layer-for-leaflet-Dk8_vWiK.js";
import { p as parseGeoRaster, g as georaster_browser_bundle_minExports } from "./georaster.browser.bundle.min-aA5IZW1l.js";
import { i as indexedDBService } from "./indexedDBService-6nGGrobl.js";
import { E as ErrorAlert } from "./ErrorAlert-NBmdjZJ0.js";
import { F as ForwardRef$1 } from "./PencilIcon-Dpq9ecTQ.js";
import { F as ForwardRef$2 } from "./ArrowLeftIcon-Ss9vMnIo.js";
import { F as ForwardRef$3 } from "./ArrowRightIcon-CBUJniDU.js";
import "./index-JjBgob5T.js";
function TrashIcon({
  title,
  titleId,
  ...props
...
const GeoRasterLeafletMap = ({
  ...
  const fallbackToImageOverlay = async (image, mapInstance, bounds, newLayers) => {
    ...
    img.onerror = (e) => {
      ...
      const isCopernicus2 = image.name.includes("Copernicus") || image.name.includes("copernicus") || image.metadata?.type === "image/tiff" || image.metadata?.type === "image/geotiff";
    ...
    imageOverlay.bindPopup(`
      <div style="max-width: 300px;">
        ...
        ${image.metadata?.isSentinel ? `<p>Sentinel Image${image.metadata?.sentinelInfo?.utmZone ? ` (UTM Zone ${image.metadata.sentinelInfo.utmZone})` : ""}</p>` : ""}
...
//# sourceMappingURL=EnhancedShorelineDigitizationPage-B1xRPv0G.js.map
