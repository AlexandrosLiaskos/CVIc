import { r as reactExports, j as jsxRuntimeExports, u as useNavigate } from "./index-DZm5JGOi.js";
import { L } from "./leaflet-src-CgZKRiRt.js";
import "./leaflet.draw-DHK4e1PG.js";
import GeoRasterLayer from "./georaster-layer-for-leaflet-DQRjE2Zu.js";
import { p as parseGeoRaster, a as georaster_browser_bundle_minExports } from "./georaster.browser.bundle.min-BrSbk4ZY.js";
import { i as indexedDBService } from "./indexedDBService-C5arrTvJ.js";
import { E as ErrorAlert } from "./ErrorAlert-BTuCIGUH.js";
import { F as ForwardRef$1 } from "./PencilIcon-D-PjFci-.js";
import { F as ForwardRef$2 } from "./ArrowLeftIcon-BKzwo4sl.js";
import { F as ForwardRef$3 } from "./ArrowRightIcon-7c6dXZNM.js";
import "./index-PGZ3NNBF.js";
function TrashIcon({
  title,
  titleId,
  ...props
...
const GeoRasterLeafletMap = ({
  ...
  console.log("GeoRasterLeafletMap received images:", images.map((img) => {
    ...
    return {
      ...
      isJP2: (_a = img.metadata) == null ? void 0 : _a.isJP2,
      isSentinel: (_b = img.metadata) == null ? void 0 : _b.isSentinel
    };
  }));
    ...
    const processImages = async () => {
      ...
      for (const image of images) {
        try {
          ...
          } else if (image.arrayBuffer && !((_a = image.metadata) == null ? void 0 : _a.isJP2)) {
            try {
              ...
              try {
                ...
                const georaster = await georaster_browser_bundle_minExports.parse(image.arrayBuffer);
                const geoRasterLayer = new GeoRasterLayer({
                  georaster,
                  opacity: 0.9,
                  // Use a moderate resolution that balances quality and performance
          ...
          async function fallbackToImageOverlay() {
            ...
            let imageBounds;
            const isCopernicus = image.name.includes("Copernicus") || image.name.includes("copernicus") || ((_a2 = image.metadata) == null ? void 0 : _a2.type) === "image/tiff" || ((_b = image.metadata) == null ? void 0 : _b.type) === "image/geotiff";
            const isCOG = image.name.includes("COG") || image.name.includes("cog") || ((_c = image.metadata) == null ? void 0 : _c.isCOG);
            if (isCOG || isCopernicus) {
              ...
              try {
                ...
                console.log("COG file details:", {
                  name: image.name,
                  size: (_d = image.metadata) == null ? void 0 : _d.size,
                  type: (_e = image.metadata) == null ? void 0 : _e.type,
                  bounds: image.bounds
                });
                const georaster = await parseGeoRaster(image.url);
                ...
                console.error("COG loading error details:", {
                  ...
                  fileName: image.name,
                  fileType: (_f = image.metadata) == null ? void 0 : _f.type,
                  fileSize: (_g = image.metadata) == null ? void 0 : _g.size,
                  isCOG: (_h = image.metadata) == null ? void 0 : _h.isCOG
                });
                if (image.name.includes("COG") || image.name.includes("cog") || ((_i = image.metadata) == null ? void 0 : _i.isCOG)) {
            ...
            if (((_j = image.metadata) == null ? void 0 : _j.isJP2) && ((_k = image.metadata) == null ? void 0 : _k.isSentinel)) {
              ...
              if (!imageBounds.isValid() || Math.abs(image.bounds[2] - image.bounds[0]) < 1e-3 || Math.abs(image.bounds[3] - image.bounds[1]) < 1e-3) {
            ...
            img.onerror = (e) => {
              ...
              const isCopernicus2 = image.name.includes("Copernicus") || image.name.includes("copernicus") || ((_a3 = image.metadata) == null ? void 0 : _a3.type) === "image/tiff" || ((_b2 = image.metadata) == null ? void 0 : _b2.type) === "image/geotiff";
              let errorMessage = "Image failed to load properly. Try converting to a different GeoTIFF format.";
              if (isCopernicus2) {
                if (image.name.includes("COG") || image.name.includes("cog") || ((_c2 = image.metadata) == null ? void 0 : _c2.isCOG)) {
            ...
            const imageOverlay = L.imageOverlay(image.url, imageBounds, {
              ...
              errorOverlayUrl: "",
              // Empty string to prevent default error image
              zIndex: 10
              // Ensure image is above base map
            });
            if (mapInstance) {
            ...
            imageOverlay.bindPopup(`
              <div style="max-width: 300px;">
                ...
                ${((_l = image.metadata) == null ? void 0 : _l.isSentinel) ? `<p>Sentinel Image${((_n = (_m = image.metadata) == null ? void 0 : _m.sentinelInfo) == null ? void 0 : _n.utmZone) ? ` (UTM Zone ${image.metadata.sentinelInfo.utmZone})` : ""}</p>` : ""}
    ...
    return () => {
      if (mapRef.current) {
        imageLayersRef.current.forEach((layer) => {
          var _a;
          try {
            (_a = mapRef.current) == null ? void 0 : _a.removeLayer(layer);
            if (layer instanceof GeoRasterLayer || layer.georaster) {
              if (layer._tiles) {
                Object.keys(layer._tiles).forEach((key) => {
                  delete layer._tiles[key];
  ...
  const handleLineStringDelete = reactExports.useCallback((id) => {
    setLineStrings(
      (prevLineStrings) => prevLineStrings.filter(
        (ls) => {
          var _a;
          return ((_a = ls.properties) == null ? void 0 : _a.id) !== id;
        }
      )
    );
  }, []);
      ...
      const newShoreline = {
        ...
        features: lineStrings.map((lineString, index) => {
          ...
          return {
            ...
            geometry: lineString,
            properties: {
              id: ((_a = lineString.properties) == null ? void 0 : _a.id) || `line-${index + 1}`
            }
          };
        })
      };
...
//# sourceMappingURL=EnhancedShorelineDigitizationPage-DSPjQKiO.js.map
