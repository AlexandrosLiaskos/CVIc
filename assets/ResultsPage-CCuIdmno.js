const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dom-to-image-BDf-riSq.js","assets/index-CFO2GDfn.js","assets/index-DS_5DDJt.css","assets/index-vtoqJjaB.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, d as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, R as React, _ as __vitePreload, u as useNavigate } from "./index-CFO2GDfn.js";
import { indexedDBService } from "./indexedDBService-BebV9TT6.js";
import { n as getCviCategory, c as featureCollection, b as bbox, M as Map$5 } from "./Map-By6C5wxr.js";
import { E as ErrorAlert } from "./ErrorAlert-xATfP7EF.js";
...
const captureMapWithDomToImage = (mapElement) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./dom-to-image-BDf-riSq.js").then((n2) => n2.d), true ? __vite__mapDeps([0,1,2]) : void 0).then((domtoimage) => {
      var _a, _b;
...
const captureMapWithLeafletImage = (mapInstance) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./index-vtoqJjaB.js").then((n2) => n2.i), true ? __vite__mapDeps([3,1,2]) : void 0).then((leafletImageModule) => {
...
//# sourceMappingURL=ResultsPage-CCuIdmno.js.map
