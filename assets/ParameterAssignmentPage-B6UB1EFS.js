import { d as commonjsGlobal, e as getAugmentedNamespace, g as getDefaultExportFromCjs, j as jsxRuntimeExports, r as reactExports, u as useNavigate } from "./index-Bxt2gUNf.js";
import { e as flattenEach, c as featureCollection$1, a as lineString, g as es, h as es$1, j as es$2, f as feature, k as featureEach$1, p as point, m as multiLineString, M as Map, n as getCviCategory, o as getCviRank, b as bbox$1, q as polygon } from "./Map-C6xOIqp9.js";
import { i as indexedDBService } from "./indexedDBService-C5arrTvJ.js";
import { a as availableFormulas } from "./formulas-CIcQv-hn.js";
import { g as getCoord, a as getGeom, b as getCoords, l as length } from "./index-oRxp_EIV.js";
...
class CVICalculator {
  ...
  static extractValues(segment, parameters) {
    ...
    parameters.forEach((param) => {
      var _a;
      const paramValue = (_a = segment.parameters) == null ? void 0 : _a[param.id];
      if (paramValue) {
...
class ICVICalculator {
  ...
  static extractValues(segment, parameters) {
    return parameters.map((param) => {
      var _a;
      const segmentValue = (_a = segment.parameters) == null ? void 0 : _a[param.id];
      return {
        ...param,
        vulnerabilityValue: (segmentValue == null ? void 0 : segmentValue.vulnerability) || 0.1
      };
    });
  }
  /**
  ...
  try {
    ...
    segments.forEach((segment, index) => {
      ...
      try {
        ...
        if (((_a = updatedSegments[index]) == null ? void 0 : _a.properties) && (updatedSegments[index].properties.vulnerabilityIndex !== indexScore || updatedSegments[index].properties.vulnerabilityFormula !== formula.type)) {
...
function ParameterAssignmentPage() {
  ...
  const cviStatistics = reactExports.useMemo(() => {
    ...
    scores.forEach((score) => {
      const rank = getCviRank(score, selectedFormula == null ? void 0 : selectedFormula.type);
...
//# sourceMappingURL=ParameterAssignmentPage-B6UB1EFS.js.map
