const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/georaster-layer-for-leaflet-DQRjE2Zu.js","assets/leaflet-src-CgZKRiRt.js","assets/index-PGZ3NNBF.js","assets/ShorelineSelectionPage-D5yX8cne.js","assets/ArrowUpTrayIcon-Dx-PAkl-.js","assets/PencilIcon-D-PjFci-.js","assets/ArrowRightIcon-7c6dXZNM.js","assets/ShorelineSourcePage-CicMhRMG.js","assets/PhotoIcon-G9-nMLj9.js","assets/ArrowLeftIcon-BKzwo4sl.js","assets/SatelliteImageUploadPage-CGjCTirp.js","assets/georaster.browser.bundle.min-BrSbk4ZY.js","assets/indexedDBService-C5arrTvJ.js","assets/ErrorAlert-BTuCIGUH.js","assets/XCircleIcon-B_JdBoUt.js","assets/EnhancedShorelineDigitizationPage-DSPjQKiO.js","assets/leaflet.draw-DHK4e1PG.js","assets/leaflet-DTT54nam.css","assets/AOISelectionPage-CBTuRXqs.js","assets/ShorelinePage-vaEB7VVB.js","assets/Map-VYnvIQGB.js","assets/CheckCircleIcon-Ci7iZQpc.js","assets/SegmentationPage-DG_Vn61I.js","assets/index-rbXMtUc0.js","assets/SegmentTablePage-CEM_gS3U.js","assets/ParameterSelectionPage-ifIC47NQ.js","assets/standardizedIndices-D_e6-F-z.js","assets/ParameterAssignmentPage-DrIWauvL.js","assets/formulas-CWbHTCK9.js","assets/ResultsPage-CT0fNBi7.js"])))=>i.map(i=>d[i]);
...
async function initializeMapLibraries() {
  if (isInitialized || initializationPromise) {
    return initializationPromise || Promise.resolve();
  }
  initializationPromise = (async () => {
    try {
      console.log("Starting map libraries initialization...");
      const [georasterModule, geoRasterLayerModule] = await Promise.all([
        __vitePreload(() => import("./georaster.browser.bundle.min-BrSbk4ZY.js").then((n2) => n2.g), true ? [] : void 0).catch((err) => {
          console.warn("Failed to load georaster:", err);
          return null;
        }),
        __vitePreload(() => import("./georaster-layer-for-leaflet-DQRjE2Zu.js"), true ? __vite__mapDeps([0,1,2]) : void 0).catch((err) => {
          console.warn("Failed to load georaster-layer-for-leaflet:", err);
          return null;
        })
      ]);
      if (georasterModule) {
        georaster = georasterModule.default || georasterModule;
        fromArrays = georaster.fromArrays;
        parse = georaster.parse;
      }
      if (geoRasterLayerModule) {
        GeoRasterLayer = geoRasterLayerModule.default || geoRasterLayerModule;
      }
      ...
      isInitialized = true;
      console.log("Map libraries initialized successfully:", {
        georaster: typeof georaster,
        GeoRasterLayer: typeof GeoRasterLayer,
        fromArrays: typeof fromArrays,
        parse: typeof parse
      });
    } catch (error) {
...
const Footer = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-gray-50 border-t border-gray-200 px-6 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto text-center space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-600 text-sm", children: [
      "Coastal Vulnerability Index Compiler - Developed by ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Alexandros Liaskos" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-500 text-xs", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          ...
          children: "HORIZON EUROPE's EO-PERSIST project"
        }
      ),
      " • ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const Layout = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50 flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-white shadow-sm border-b border-gray-200 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center h-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/home", className: "flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-semibold text-gray-900", children: "CVIc" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center space-x-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: "/home",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 max-w-7xl mx-auto py-6 sm:px-6 lg:px-8 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-6 sm:px-0 h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) }),
...
class ErrorBoundary extends reactExports.Component {
  ...
  render() {
    ...
    if (this.state.hasError) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center bg-gray-50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl w-full space-y-8 p-8 bg-white shadow-lg rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-red-600 mb-4", children: "Something went wrong" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left mb-6 p-4 bg-red-50 rounded-md border border-red-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-700 font-semibold mb-2", children: "Error:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-800 mb-4", children: ((_a = this.state.error) == null ? void 0 : _a.message) || "An unexpected error occurred" }),
          this.state.errorStack && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-700 font-semibold mb-2", children: "Stack Trace:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "text-xs bg-gray-100 p-3 rounded overflow-auto max-h-40", children: this.state.errorStack })
          ] }),
          this.state.errorInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-700 font-semibold mb-2", children: "Component Stack:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "text-xs bg-gray-100 p-3 rounded overflow-auto max-h-40", children: this.state.errorInfo.componentStack })
          ] })
        ] }),
...
const ForwardRef$5 = /* @__PURE__ */ reactExports.forwardRef(ChartBarIcon);
...
const ForwardRef$4 = /* @__PURE__ */ reactExports.forwardRef(ChevronRightIcon);
function ClockIcon({
  title,
  titleId,
  ...props
...
const ForwardRef$3 = /* @__PURE__ */ reactExports.forwardRef(ClockIcon);
...
const ForwardRef$2 = /* @__PURE__ */ reactExports.forwardRef(GlobeAltIcon);
function MapIcon({
  title,
  titleId,
  ...props
...
const ForwardRef$1 = /* @__PURE__ */ reactExports.forwardRef(MapIcon);
...
const ForwardRef = /* @__PURE__ */ reactExports.forwardRef(ShieldCheckIcon);
function RootPage() {
  ...
  const workflowSteps = [
    {
      ...
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$2, { className: "h-6 w-6 text-blue-600" })
    },
    {
      title: "Select Index",
      description: "Select vulnerability index",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$5, { className: "h-6 w-6 text-blue-600" })
    },
    {
      title: "Assign Values",
      description: "Assign values interactively on the map",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$1, { className: "h-6 w-6 text-blue-600" })
    },
    {
      title: "Export Results ",
      description: "Export results and report",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef, { className: "h-6 w-6 text-blue-600" })
    }
  ];
  const benefits = [
    {
      ...
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$3, { className: "h-8 w-8 text-blue-600" })
    },
    {
      title: "End-to-End Workflow",
      description: "From shoreline to CVI results",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef, { className: "h-8 w-8 text-blue-600" })
    },
    {
      title: "Free and Open Source",
      description: "Transparency and collaboration",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$5, { className: "h-8 w-8 text-blue-600" })
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-gray-50 to-white min-h-screen flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl sm:text-5xl font-bold text-gray-900 tracking-tight mb-6", children: "Coastal Vulnerability Index Compiler" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-gray-600 mb-4 max-w-3xl mx-auto" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-500 max-w-2xl mx-auto", children: "First web application specialized for the automation of Coastal Vulnerability Assessment" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "text-center mb-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        to: "/shoreline-selection",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-12 text-center", children: "How It Works" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: workflowSteps.map((step, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start space-x-4 p-6 bg-gray-50 rounded-xl border border-gray-100 hover:shadow-lg hover:border-blue-200 transition-all duration-300", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center", children: step.icon }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-12 text-center", children: "Why Choose CVIc?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: benefits.map((benefit, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center p-6 bg-white rounded-xl border border-gray-100 hover:shadow-lg transition-all duration-300", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-4", children: benefit.icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-gray-900 mb-3", children: benefit.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 leading-relaxed", children: benefit.description })
      ] }, index)) })
    ] })
  ] }) });
}
const ShorelineSelectionPage = reactExports.lazy(() => __vitePreload(() => import("./ShorelineSelectionPage-D5yX8cne.js"), true ? __vite__mapDeps([3,4,5,6]) : void 0));
const ShorelineSourcePage = reactExports.lazy(() => __vitePreload(() => import("./ShorelineSourcePage-CicMhRMG.js"), true ? __vite__mapDeps([7,8,9,6]) : void 0));
const SatelliteImageUploadPage = reactExports.lazy(() => __vitePreload(() => import("./SatelliteImageUploadPage-CGjCTirp.js").then((n2) => n2.S), true ? __vite__mapDeps([10,11,12,13,4,8,14,9,6]) : void 0));
const EnhancedShorelineDigitizationPage = reactExports.lazy(() => __vitePreload(() => import("./EnhancedShorelineDigitizationPage-DSPjQKiO.js"), true ? __vite__mapDeps([15,1,16,17,0,2,11,12,13,5,9,6]) : void 0));
const AOISelectionPage = reactExports.lazy(() => __vitePreload(() => import("./AOISelectionPage-CBTuRXqs.js"), true ? __vite__mapDeps([18,1,16,17,0,2,13,9,6]) : void 0));
const ShorelinePage = reactExports.lazy(() => __vitePreload(() => import("./ShorelinePage-vaEB7VVB.js"), true ? __vite__mapDeps([19,2,12,20,1,16,17,13,4,21,14]) : void 0));
const SegmentationPage = reactExports.lazy(() => __vitePreload(() => import("./SegmentationPage-DG_Vn61I.js"), true ? __vite__mapDeps([22,20,1,16,17,23,12,13,21,9,6]) : void 0));
const SegmentTablePage = reactExports.lazy(() => __vitePreload(() => import("./SegmentTablePage-CEM_gS3U.js"), true ? __vite__mapDeps([24,20,1,16,17,12,13,9,6,21,23]) : void 0));
const ParameterSelectionPage = reactExports.lazy(() => __vitePreload(() => import("./ParameterSelectionPage-ifIC47NQ.js"), true ? __vite__mapDeps([25,12,26]) : void 0));
const ParameterAssignmentPage = reactExports.lazy(() => __vitePreload(() => import("./ParameterAssignmentPage-DrIWauvL.js"), true ? __vite__mapDeps([27,20,1,16,17,12,28,23,13]) : void 0));
const ResultsPage = reactExports.lazy(() => __vitePreload(() => import("./ResultsPage-CT0fNBi7.js"), true ? __vite__mapDeps([29,12,20,1,16,17,13,28,26]) : void 0));
const LoadingComponent = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-primary-600" }) });
function LazyWrapper({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingComponent, {}), children });
}
const routes = [
  {
    path: "/",
    element: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, {}) }),
    errorElement: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Something went wrong" }),
    children: [
      {
        index: true,
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(RootPage, {})
      },
      {
        path: "home",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(RootPage, {})
      },
      {
        ...
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(LazyWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShorelineSelectionPage, {}) })
      },
      {
        path: "shoreline-source",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(LazyWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShorelineSourcePage, {}) })
      },
      {
        path: "satellite-upload",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(LazyWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SatelliteImageUploadPage, {}) })
      },
      {
        path: "enhanced-shoreline-digitization",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(LazyWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(EnhancedShorelineDigitizationPage, {}) })
      },
      {
        path: "aoi-selection",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(LazyWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AOISelectionPage, {}) })
      },
      {
        path: "shoreline",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(LazyWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShorelinePage, {}) })
      },
      {
        path: "segmentation",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(LazyWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SegmentationPage, {}) })
      },
      {
        path: "segment-table",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(LazyWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SegmentTablePage, {}) })
      },
      {
        path: "parameter-selection",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(LazyWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ParameterSelectionPage, {}) })
      },
      {
        path: "parameter-assignment",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(LazyWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ParameterAssignmentPage, {}) })
      },
      {
        path: "results",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(LazyWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResultsPage, {}) })
      }
    ]
  }
];
...
//# sourceMappingURL=index-DZm5JGOi.js.map
