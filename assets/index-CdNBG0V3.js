import { e as getAugmentedNamespace, g as getDefaultExportFromCjs } from "./index-Cgv5OTPG.js";
...
var queue = require$$0.queue;
var cacheBusterDate = +/* @__PURE__ */ new Date();
var leafletImage = function leafletImage2(map, callback) {
  ...
  function handleTileLayer(layer, callback2) {
    ...
    ), tiles = [], j, i, tileQueue = new queue(1);
...
const index = /* @__PURE__ */ getDefaultExportFromCjs(leafletImage);
...
//# sourceMappingURL=index-CdNBG0V3.js.map
