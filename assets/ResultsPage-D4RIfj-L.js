const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dom-to-image-CEONnMZQ.js","assets/index-DLPZH9q0.js","assets/index-Cj-sxlKB.css","assets/index-DYAGNYF3.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, d as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, R as React, _ as __vitePreload, u as useNavigate } from "./index-DLPZH9q0.js";
import { i as indexedDBService } from "./indexedDBService-6nGGrobl.js";
import { h as getCviCategory, c as featureCollection, b as bbox, M as Map$1 } from "./Map-CRImvwo6.js";
import { E as ErrorAlert } from "./ErrorAlert-B-U-Zhxv.js";
...
const captureMapWithDomToImage = (mapElement) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./dom-to-image-CEONnMZQ.js").then((n) => n.d), true ? __vite__mapDeps([0,1,2]) : void 0).then((domtoimage) => {
...
const captureMapWithLeafletImage = (mapInstance) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./index-DYAGNYF3.js").then((n) => n.i), true ? __vite__mapDeps([3,1,2]) : void 0).then((leafletImageModule) => {
...
//# sourceMappingURL=ResultsPage-D4RIfj-L.js.map
