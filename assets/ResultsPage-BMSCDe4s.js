const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dom-to-image-BtH1XOC_.js","assets/index-DMu4DUtd.js","assets/index-6p7NRmL9.css","assets/index-COGRhfet.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, e as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, R as React, _ as __vitePreload, u as useNavigate } from "./index-DMu4DUtd.js";
import { i as indexedDBService } from "./indexedDBService-C5arrTvJ.js";
import { n as getCviCategory, c as featureCollection, b as bbox, M as Map$5 } from "./Map-BbJe1dQz.js";
import { E as ErrorAlert } from "./ErrorAlert-Dep2OOfL.js";
...
const captureMapWithDomToImage = (mapElement) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./dom-to-image-BtH1XOC_.js").then((n2) => n2.d), true ? __vite__mapDeps([0,1,2]) : void 0).then((domtoimage) => {
      var _a, _b;
...
const captureMapWithLeafletImage = (mapInstance) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./index-COGRhfet.js").then((n2) => n2.i), true ? __vite__mapDeps([3,1,2]) : void 0).then((leafletImageModule) => {
...
//# sourceMappingURL=ResultsPage-BMSCDe4s.js.map
