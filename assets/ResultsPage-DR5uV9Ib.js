const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dom-to-image-WKn4L_0g.js","assets/index-OGmXEiPu.js","assets/index-Cj-sxlKB.css","assets/index-DqIkarrR.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, c as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, R as React, _ as __vitePreload, u as useNavigate } from "./index-OGmXEiPu.js";
import { i as indexedDBService } from "./indexedDBService-6nGGrobl.js";
import { h as getCviCategory, c as featureCollection, b as bbox, M as Map$1 } from "./Map-DZ66HozX.js";
...
import "./leaflet-src-CtcoMqTs.js";
...
const captureMapWithDomToImage = (mapElement) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./dom-to-image-WKn4L_0g.js").then((n) => n.d), true ? __vite__mapDeps([0,1,2]) : void 0).then((domtoimage) => {
...
const captureMapWithLeafletImage = (mapInstance) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./index-DqIkarrR.js").then((n) => n.i), true ? __vite__mapDeps([3,1,2]) : void 0).then((leafletImageModule) => {
...
//# sourceMappingURL=ResultsPage-DR5uV9Ib.js.map
