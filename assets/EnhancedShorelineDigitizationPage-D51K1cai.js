import { r as reactExports, L, G as GeoRasterLayer, j as jsxRuntimeExports, p as parseGeoRaster, a as georaster_browser_bundle_minExports, u as useNavigate } from "./index-Bxt2gUNf.js";
...
import { F as ForwardRef$1 } from "./PencilIcon-COfRYvOM.js";
import { F as ForwardRef$2 } from "./ArrowLeftIcon-CumG89lf.js";
import { F as ForwardRef$3 } from "./ArrowRightIcon-BzBJ1pES.js";
function TrashIcon({
  title,
  titleId,
  ...props
...
const GeoRasterLeafletMap = ({
  ...
  const fallbackToImageOverlay = async (image, mapInstance, bounds, newLayers) => {
    ...
    let imageBounds;
    const isCopernicus = image.name.includes("Copernicus") || image.name.includes("copernicus") || ((_a = image.metadata) == null ? void 0 : _a.type) === "image/tiff" || ((_b = image.metadata) == null ? void 0 : _b.type) === "image/geotiff";
    ...
    img.onerror = (e) => {
      ...
      const isCopernicus2 = image.name.includes("Copernicus") || image.name.includes("copernicus") || ((_a2 = image.metadata) == null ? void 0 : _a2.type) === "image/tiff" || ((_b2 = image.metadata) == null ? void 0 : _b2.type) === "image/geotiff";
    ...
    imageOverlay.bindPopup(`
      <div style="max-width: 300px;">
        ...
        ${((_f = image.metadata) == null ? void 0 : _f.isSentinel) ? `<p>Sentinel Image${((_h = (_g = image.metadata) == null ? void 0 : _g.sentinelInfo) == null ? void 0 : _h.utmZone) ? ` (UTM Zone ${image.metadata.sentinelInfo.utmZone})` : ""}</p>` : ""}
  ...
  const handleLineStringDelete = reactExports.useCallback((id) => {
    setLineStrings(
      (prevLineStrings) => prevLineStrings.filter(
        (ls, index) => {
          var _a;
          return ((_a = ls.properties) == null ? void 0 : _a.id) !== id && `line-${index + 1}` !== id;
        }
      )
    );
  }, []);
...
//# sourceMappingURL=EnhancedShorelineDigitizationPage-D51K1cai.js.map
