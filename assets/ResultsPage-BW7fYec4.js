const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dom-to-image-CiRYCArH.js","assets/index-ddXViGMs.js","assets/index-BCyhnAXD.css","assets/index-Q33i9VUx.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, d as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, R as React, _ as __vitePreload, u as useNavigate } from "./index-ddXViGMs.js";
import { i as indexedDBService } from "./indexedDBService-6nGGrobl.js";
import { h as getCviCategory, c as featureCollection, b as bbox, M as Map$1 } from "./Map-DHk4Psc-.js";
import { E as ErrorAlert } from "./ErrorAlert-Ct7DCyoL.js";
...
const captureMapWithDomToImage = (mapElement) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./dom-to-image-CiRYCArH.js").then((n) => n.d), true ? __vite__mapDeps([0,1,2]) : void 0).then((domtoimage) => {
...
const captureMapWithLeafletImage = (mapInstance) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./index-Q33i9VUx.js").then((n) => n.i), true ? __vite__mapDeps([3,1,2]) : void 0).then((leafletImageModule) => {
...
//# sourceMappingURL=ResultsPage-BW7fYec4.js.map
