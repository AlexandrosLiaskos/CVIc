import { g as getDefaultExportFromCjs, j as jsxRuntimeExports, r as reactExports, u as useNavigate } from "./index-CFtzeYoU.js";
import { e as flattenEach, c as featureCollection, a as lineString, f as feature, g as featureEach, p as point, m as multiLineString, M as Map, h as getCviCategory, j as getCviRank, b as bbox$1, k as polygon } from "./Map-Dbk5FvJw.js";
import { i as indexedDBService } from "./indexedDBService-6nGGrobl.js";
import { a as availableFormulas } from "./formulas-CIcQv-hn.js";
import { g as getCoord, a as getGeom, b as getCoords, l as length } from "./index-DiBLGZ5I.js";
  ...
  const loadData = reactExports.useCallback(async () => {
    ...
    try {
      ...
      const loadedSegments = segmentData.features.filter((feature2) => feature2 && feature2.geometry && (feature2.geometry.type === "LineString" || feature2.geometry.type === "MultiLineString")).map((feature2, index) => {
        const segmentId = feature2.properties?.id || `segment-${index + 1}`;
...
//# sourceMappingURL=ParameterAssignmentPage-C-gFiN5q.js.map
