const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dom-to-image-DepeR-4Y.js","assets/index-C-yOgL9c.js","assets/index-BJIyFbgs.css","assets/index-Bf_LlzA3.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, d as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, R as React, _ as __vitePreload, u as useNavigate } from "./index-C-yOgL9c.js";
import { i as indexedDBService } from "./indexedDBService-C5arrTvJ.js";
import { n as getCviCategory, c as featureCollection, b as bbox, M as Map$5 } from "./Map-DdtPej6O.js";
import { E as ErrorAlert } from "./ErrorAlert-0ilFUEjI.js";
...
const captureMapWithDomToImage = (mapElement) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./dom-to-image-DepeR-4Y.js").then((n2) => n2.d), true ? __vite__mapDeps([0,1,2]) : void 0).then((domtoimage) => {
      var _a, _b;
...
const captureMapWithLeafletImage = (mapInstance) => {
  return new Promise((resolve, reject) => {
    __vitePreload(() => import("./index-Bf_LlzA3.js").then((n2) => n2.i), true ? __vite__mapDeps([3,1,2]) : void 0).then((leafletImageModule) => {
...
//# sourceMappingURL=ResultsPage-FtXwQY9J.js.map
