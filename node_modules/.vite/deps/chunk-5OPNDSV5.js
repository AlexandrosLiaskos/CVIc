...
addDecoder([8, 32946], () => import("./deflate-USXLA4HR.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-RGIFIYW4.js").then((m) => m.default));
addDecoder(
  34887,
  () => import("./lerc-GFHSJIR7.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
...
//# sourceMappingURL=chunk-5OPNDSV5.js.map
